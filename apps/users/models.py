...
from apps.adminpage.models import (
    NOTIFY_TYPE_ADD_NEW_FEATURE, NOTIFY_TYPE_ADD_NEW_FOLDER,
    NOTIFY_TYPE_PROMOTIONAL_CAMPAIGN, NOTIFY_TYPE_PRE_ORDER,
    NOTIFY_TYPE_UPDATE_CONTENT, NOTIFY_TYPE_LOGIN_REMINDER,
    NOTIFY_TYPE_EVENT,
)
...
NOTIFY_TYPE_CHOICES = (
    ...
    (NOTIFY_TYPE_PROMOTIONAL_CAMPAIGN, 'Promotional Campain'),
