...
class DetailNotifySerializer(serializers.ModelSerializer):
    class Meta:
        model = user_models.Notification
        fields = ('id', 'title', 'body', 'notify_type', 'created_at')


class NotifyValidator(serializers.Serializer):
...
class ListNotifySerializer(serializers.ModelSerializer):
    is_read = serializers.BooleanField(default=False)

    class Meta:
        model = user_models.Notification
        fields = ('id', 'title', 'body', 'notify_type', 'is_read')
